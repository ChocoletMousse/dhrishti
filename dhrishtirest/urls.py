...
urlpatterns = [
    ...
    path("search/comments", views.load_analyse_comments, name="load-submission-comments"),
    path("data/comments", views.get_comments_data, name="get-comments-data"),
    path("data/comments/<str:submission_id>", views.get_comments_by_submission, name="get-comments-data-for-submission")
]
